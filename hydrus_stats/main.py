...
from hydrus_stats.basic_stats import generate_vocab
from hydrus_stats.mutual_information import calculate_mututal_information
from hydrus_stats.utils import load_counts_from_file
from argparse import ArgumentParser
from basic_stats import generate_counts
from mutual_information import calculate_cooccurrences, sort_tag_pairs_by_pmi
from tf_idf import sort_images_by_tf_idf
import sys
...
def parse_args():
    ...
    mi_parser.add_argument("--tag-to-query", type=str, dest="query", nargs='+')
    ...
    args = parser.parse_args("mi --tag-to-query tentacles".split())
...
def main():
    ...
    if args.task == "tfidf":
        sort_images_by_tf_idf(metadata, tag2idx, tag_counts, num_documents)
    elif args.task == "mi":
